...
Uses Math, SysUtils, SP_Components, SP_SysVars, SP_Input, SP_Sound, {$IFNDEF FPC}Vcl.ClipBrd{$ELSE}{$IFDEF SDL2}SP_SDL2Compat{$ELSE}ClipBrd{$ENDIF}{$ENDIF}, SP_Interpret_PostFix, SP_BankManager, SP_BankFiling;
